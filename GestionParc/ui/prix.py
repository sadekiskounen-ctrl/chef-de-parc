...
class PrixFrame(ctk.CTkFrame):
    ...
    def build(self):
        ...
        self.tree.column('ref', width=110, anchor='center', stretch=True)
        self.tree.column('fournisseur', width=110, anchor='center', stretch=True)
        self.tree.column('designation', width=200, anchor='w', stretch=True)
        self.tree.column('ancien', width=120, anchor='center', stretch=True)
        self.tree.column('nouveau', width=120, anchor='center', stretch=True)
        self.tree.column('marge_dzd', width=120, anchor='center', stretch=True)
        self.tree.column('marge_pct', width=100, anchor='center', stretch=True)
        self.tree.column('statut', width=130, anchor='center', stretch=True)
